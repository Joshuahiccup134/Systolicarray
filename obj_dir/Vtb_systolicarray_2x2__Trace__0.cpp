...
void Vtb_systolicarray_2x2___024root__trace_chg_0_sub_0(Vtb_systolicarray_2x2___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[3U] 
        ...
        bufp->chgSData(oldp+19,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__B_in
                                [1U][1U]),16);
        bufp->chgSData(oldp+20,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__B_in_staggered
                                [0U][0U]),16);
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        bufp->chgIData(oldp+24,(vlSelfRef.tb_systolicarray_2x2__DOT__C_out
                                [0U][0U]),32);
        bufp->chgIData(oldp+25,(vlSelfRef.tb_systolicarray_2x2__DOT__C_out
                                [0U][1U]),32);
        bufp->chgIData(oldp+26,(vlSelfRef.tb_systolicarray_2x2__DOT__C_out
                                [1U][0U]),32);
        bufp->chgIData(oldp+27,(vlSelfRef.tb_systolicarray_2x2__DOT__C_out
                                [1U][1U]),32);
        bufp->chgIData(oldp+28,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__C_out
                                [0U][0U]),32);
        bufp->chgIData(oldp+29,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__C_out
                                [0U][1U]),32);
        bufp->chgIData(oldp+30,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__C_out
                                [1U][0U]),32);
        bufp->chgIData(oldp+31,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__C_out
                                [1U][1U]),32);
        ...
        bufp->chgIData(oldp+37,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT____Vcellout__row_loop__BRA__0__KET____DOT__col_loop__BRA__1__KET____DOT__mac_inst__C_out),32);
        ...
        bufp->chgIData(oldp+40,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT____Vcellout__row_loop__BRA__1__KET____DOT__col_loop__BRA__0__KET____DOT__mac_inst__C_out),32);
        ...
        bufp->chgIData(oldp+43,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT____Vcellout__row_loop__BRA__1__KET____DOT__col_loop__BRA__1__KET____DOT__mac_inst__C_out),32);
    }
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[4U] 
                      | vlSelfRef.__Vm_traceActivity
                      [5U])))) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[5U]))) {
        bufp->chgBit(oldp+68,(vlSelfRef.tb_systolicarray_2x2__DOT__done));
        ...
        bufp->chgBit(oldp+72,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__enable_bus
                              [1U][1U]));
        bufp->chgIData(oldp+73,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__i),32);
        bufp->chgIData(oldp+74,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__j),32);
        bufp->chgIData(oldp+75,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__k),32);
        bufp->chgIData(oldp+76,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__row_i),32);
        bufp->chgIData(oldp+77,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__col_j),32);
        bufp->chgIData(oldp+78,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__clkcount),32);
        bufp->chgBit(oldp+79,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__running));
        bufp->chgBit(oldp+80,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__enable_bus
                              [0U][0U]));
        bufp->chgBit(oldp+81,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__enable_bus
                              [0U][1U]));
        bufp->chgBit(oldp+82,(vlSelfRef.tb_systolicarray_2x2__DOT__dut__DOT__enable_bus
                              [1U][0U]));
